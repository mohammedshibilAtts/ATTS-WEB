...
const Card = ({ title, description, icon }) => {
  return (
    <div className="bg-[#010202] xl:hover:border-gray-100 p-6 text-white border border-[#FFFFFF26] flex flex-col h-full transition-all duration-300 ease-in-out xl:hover:scale-105 hover:bg-[#010202]">
      {icon && (
